...
# Construct stacking
ensemble = blending(X_train, y_train, X_test, val_size=0.4, save_dir='.',
...
if ensemble.next_train.shape[1] == 4:  # n_models(2)  + progate(2)
    print("     pass the test!")
...
if ensemble.next_train.shape[1] == 6:  # n_models(3)  + subset(2) + progate(1)
    print("     pass the test!")
